...
| `LINE_NOTIFICATION_USE_ALLOWLIST` | 限定βだけ`true`。private DB allowlistをenqueue、claim、送信直前に強制 |
| `LINE_NOTIFICATION_ALLOW_ALL` | 限定β後の別承認で明示的に`true`へするまで全会員enqueueを拒否 |
